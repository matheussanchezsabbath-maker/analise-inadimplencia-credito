...
O código completo e comentado está em [`analise_inadimplencia.sql`](analise_inadimplencia.sql).
...
O Marketplace B tem **1,8x a taxa média da carteira**. E o número que dimensiona o impacto: ele representa **11% dos contratos, mas responde por 21% de todos os defaults**.
...
```
├── README.md
├── analise_inadimplencia.sql    # todas as queries, comentadas
